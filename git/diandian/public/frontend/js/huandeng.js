...
glide.layerGlide(true,'icon_num','show_pic',720,4,0.1,'left');
		/**参数设置
...
setInterval("scroll(document.getElementById('wsxr_lb'))",20);

setInterval("scroll(document.getElementById('hhh'))",20);
