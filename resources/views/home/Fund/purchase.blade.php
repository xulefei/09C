                    ...
                    <div class="zhuanzhang_l">
                        <form action="" method="post">
                            <ul>
                                ...
                                <li><span>金融宝余额：&nbsp;</span><b></b>&nbsp;元<i style="font-style:normal;"><a href="" target="_blank" style="color:#3d89b4;">&nbsp;&nbsp;【充值】</a></i></li>
                                
                                <li><span>转入金额：&nbsp;</span><input type="text" name="fund" />&nbsp;元<i style="color:#999; font-style:normal;">（金额不能低于100元，且必须是50的倍数）</i></li>
                                <li><span>交易密码：&nbsp;</span><input type="password" name="safePass" /></li>
                                <li><span>预计收益日期：&nbsp;</span><i style="color:#999; font-style:normal;">（最长不超过72小时）</i></li>
                                <li><span>&nbsp;</span>
                                    <input type="submit" value="" class="zhuanzhang_eebao" />
                                </li>
                              
                                <span style="margin-left:150px;color:red">转入资金，需要先设置交易密码！ <a href="" style="color:blue">去设置 >></a></span>
